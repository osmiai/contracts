...
const OSMI_STAKING_AND_COMMUNITY_INITIATIVES_ADDRESS = vars.get("OSMI_STAKING_AND_COMMUNITY_INITIATIVES_ADDRESS")
  ...
  networks: {
    mainnet: {
      ...
      ledgerAccounts: [
        ...
        OSMI_STAKING_AND_COMMUNITY_INITIATIVES_ADDRESS,
      ],
    },
    sepolia: {
